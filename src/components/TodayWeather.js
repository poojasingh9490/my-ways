    ...
    <div className="main-card-2">
      ...
      <div className="card-feature-1">
        ...
        <div className="card-feature-2">
          ...
          <div className="card-feature-4">Dew Point</div>
          <div className="feature">
            <span>23°</span>
          </div>
        </div>
        <div className="card-feature-2">
          ...
          <div className="card-feature-4">Pressure</div>
          <div className="feature">
            <span>
              <svg
                name="arrow-down"
        ...
        <div className="card-feature-2">
          ...
          <div className="card-feature-4">UV Index</div>
          <div className="feature">
        ...
        <div className="card-feature-2">
          ...
          <div className="card-feature-4">Moon Phase</div>
          <div className="feature">Waxing Gibbous</div>
        </div>
      </div>
    </div>
  );
